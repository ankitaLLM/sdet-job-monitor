...
const COMPANY_REGISTRY = {
  ...
  // Clario & Life Sciences / HealthTech Peers
  'clario': { domain: 'clario.com', ats: 'workday', careerUrl: 'https://clario.com/careers/' },
  'medidata': { domain: 'medidata.com', ats: 'workday', careerUrl: 'https://www.medidata.com/en/careers/' },
  'medidata solutions': { domain: 'medidata.com', ats: 'workday', careerUrl: 'https://www.medidata.com/en/careers/' },
  'veeva': { domain: 'veeva.com', ats: 'greenhouse', board: 'veevasystems', careerUrl: 'https://careers.veeva.com/' },
  'veeva systems': { domain: 'veeva.com', ats: 'greenhouse', board: 'veevasystems', careerUrl: 'https://careers.veeva.com/' },
  'iqvia': { domain: 'iqvia.com', ats: 'workday', careerUrl: 'https://jobs.iqvia.com/' },
  'signant health': { domain: 'signanthealth.com', ats: 'greenhouse', board: 'signanthealth', careerUrl: 'https://signanthealth.com/careers/' },
  'parexel': { domain: 'parexel.com', ats: 'workday', careerUrl: 'https://jobs.parexel.com/' },
  'tempus': { domain: 'tempus.com', ats: 'greenhouse', board: 'tempus', careerUrl: 'https://www.tempus.com/careers/' },
  'tempus labs': { domain: 'tempus.com', ats: 'greenhouse', board: 'tempus', careerUrl: 'https://www.tempus.com/careers/' },
  'flatiron health': { domain: 'flatiron.com', ats: 'greenhouse', board: 'flatironhealth', careerUrl: 'https://flatiron.com/careers/' },
  'epic': { domain: 'epic.com', ats: 'corporate-portal', careerUrl: 'https://epic.com/careers' },
  'epic systems': { domain: 'epic.com', ats: 'corporate-portal', careerUrl: 'https://epic.com/careers' },
  'doximity': { domain: 'doximity.com', ats: 'greenhouse', board: 'doximity', careerUrl: 'https://www.doximity.com/careers' },
  'teladoc': { domain: 'teladochealth.com', ats: 'workday', careerUrl: 'https://www.teladochealth.com/careers/' },
  'illumina': { domain: 'illumina.com', ats: 'workday', careerUrl: 'https://illumina.wd1.myworkdayjobs.com/illumina-careers' },
  'ge healthcare': { domain: 'gehealthcare.com', ats: 'workday', careerUrl: 'https://jobs.gecareers.com/healthcare/global/en' },
  'abbott': { domain: 'abbott.com', ats: 'workday', careerUrl: 'https://www.abbott.com/careers.html' },
  'medtronic': { domain: 'medtronic.com', ats: 'workday', careerUrl: 'https://www.medtronic.com/us-en/about/careers.html' },
  'boston scientific': { domain: 'bostonscientific.com', ats: 'workday', careerUrl: 'https://bostonscientific.wd1.myworkdayjobs.com/careers' },
  'stryker': { domain: 'stryker.com', ats: 'workday', careerUrl: 'https://careers.stryker.com/' },
  'baxter': { domain: 'baxter.com', ats: 'workday', careerUrl: 'https://jobs.baxter.com/' },
  'labcorp': { domain: 'labcorp.com', ats: 'workday', careerUrl: 'https://jobs.labcorp.com/' },
  'quest diagnostics': { domain: 'questdiagnostics.com', ats: 'workday', careerUrl: 'https://careers.questdiagnostics.com/' },

  // Agri-Finance, Commodity Trading & Crop FinTech Peers
  'cargill': { domain: 'cargill.com', ats: 'workday', careerUrl: 'https://careers.cargill.com/' },
  'adm': { domain: 'adm.com', ats: 'workday', careerUrl: 'https://www.adm.com/en-us/culture-and-careers/' },
  'archer daniels midland': { domain: 'adm.com', ats: 'workday', careerUrl: 'https://www.adm.com/en-us/culture-and-careers/' },
  'bunge': { domain: 'bunge.com', ats: 'workday', careerUrl: 'https://jobs.bunge.com/' },
  'louis dreyfus': { domain: 'ldc.com', ats: 'workday', careerUrl: 'https://www.ldc.com/careers/' },
  'louis dreyfus company': { domain: 'ldc.com', ats: 'workday', careerUrl: 'https://www.ldc.com/careers/' },
  'chs': { domain: 'chsinc.com', ats: 'workday', careerUrl: 'https://jobs.chsinc.com/' },
  'chs inc': { domain: 'chsinc.com', ats: 'workday', careerUrl: 'https://jobs.chsinc.com/' },
  'scoular': { domain: 'scoular.com', ats: 'workday', careerUrl: 'https://www.scoular.com/careers' },
  'cobank': { domain: 'cobank.com', ats: 'workday', careerUrl: 'https://www.cobank.com/careers' },
  'farm credit': { domain: 'fcsamerica.com', ats: 'workday', careerUrl: 'https://www.fcsamerica.com/careers' },
  'farm credit services of america': { domain: 'fcsamerica.com', ats: 'workday', careerUrl: 'https://www.fcsamerica.com/careers' },
  'bushel': { domain: 'bushelpowered.com', ats: 'greenhouse', board: 'bushel', careerUrl: 'https://bushelpowered.com/careers/' },
  'agvend': { domain: 'agvend.com', ats: 'greenhouse', board: 'agvend', careerUrl: 'https://www.agvend.com/careers' },
  'producepay': { domain: 'producepay.com', ats: 'greenhouse', board: 'producepay', careerUrl: 'https://producepay.com/careers/' },

  // Precision Agricultural Technology (AgTech)
  'nutrien ag solutions': { domain: 'nutrien.com', ats: 'workday', careerUrl: 'https://www.nutrien.com/careers' },
  'corteva': { domain: 'corteva.com', ats: 'workday', careerUrl: 'https://corteva.wd1.myworkdayjobs.com/corteva' },
  'corteva agriscience': { domain: 'corteva.com', ats: 'workday', careerUrl: 'https://corteva.wd1.myworkdayjobs.com/corteva' },
  'granular': { domain: 'granular.ag', ats: 'workday', careerUrl: 'https://corteva.wd1.myworkdayjobs.com/corteva' },
  'bayer': { domain: 'bayer.com', ats: 'corporate-portal', careerUrl: 'https://www.bayer.com/en/career' },
  'bayer crop science': { domain: 'bayer.com', ats: 'corporate-portal', careerUrl: 'https://www.bayer.com/en/career' },
  'climate fieldview': { domain: 'climate.com', ats: 'corporate-portal', careerUrl: 'https://www.climate.com/careers' },
  'john deere': { domain: 'deere.com', ats: 'workday', careerUrl: 'https://jobs.deere.com/' },
  'deere & company': { domain: 'deere.com', ats: 'workday', careerUrl: 'https://jobs.deere.com/' },
  'syngenta': { domain: 'syngenta.com', ats: 'workday', careerUrl: 'https://www.syngenta.com/en/careers' },
  'trimble': { domain: 'trimble.com', ats: 'workday', careerUrl: 'https://trimble.wd1.myworkdayjobs.com/TrimbleCareers' },
  'indigo ag': { domain: 'indigoag.com', ats: 'greenhouse', board: 'indigo', careerUrl: 'https://www.indigoag.com/careers' },
  'cnh industrial': { domain: 'cnhindustrial.com', ats: 'workday', careerUrl: 'https://www.cnhindustrial.com/en-us/people-and-careers' },
  'fmc': { domain: 'fmc.com', ats: 'workday', careerUrl: 'https://www.fmc.com/en/careers' },
  'yara': { domain: 'yara.com', ats: 'workday', careerUrl: 'https://www.yara.com/careers/' },
  'agco': { domain: 'agcocorp.com', ats: 'workday', careerUrl: 'https://careers.agcocorp.com/' },
  'caterpillar': { domain: 'caterpillar.com', ats: 'workday', careerUrl: 'https://www.caterpillar.com/en/careers.html' },
  'rockwell automation': { domain: 'rockwellautomation.com', ats: 'workday', careerUrl: 'https://rockwellautomation.wd1.myworkdayjobs.com/rockwellcareers' },
  'honeywell': { domain: 'honeywell.com', ats: 'workday', careerUrl: 'https://careers.honeywell.com/us/en' },
  'emerson': { domain: 'emerson.com', ats: 'workday', careerUrl: 'https://www.emerson.com/en-us/careers' },
  'schneider electric': { domain: 'se.com', ats: 'workday', careerUrl: 'https://www.se.com/us/en/about-us/careers/overview.jsp' },
  'abb': { domain: 'abb.com', ats: 'workday', careerUrl: 'https://global.abb/group/en/careers' },
  'eaton': { domain: 'eaton.com', ats: 'workday', careerUrl: 'https://www.eaton.com/us/en-us/company/careers.html' },
  'westinghouse': { domain: 'westinghousenuclear.com', ats: 'workday', careerUrl: 'https://info.westinghousenuclear.com/careers' },
  'wabtec': { domain: 'wabteccorp.com', ats: 'workday', careerUrl: 'https://www.wabteccorp.com/careers' },
  'msa safety': { domain: 'msasafety.com', ats: 'workday', careerUrl: 'https://us.msasafety.com/careers' },
